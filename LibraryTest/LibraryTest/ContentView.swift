...
//  LibraryTest
//
//  Created by Catalina Beta on 11/07/2019.
    ...
    var body: some View {
        return VStack {
            Rectangle()
                ...
                .cornerRadius(3.0)
                .opacity(0.1)
            Text("This certificate is proof that Daniel K has rocked the UI Design course with approval from a Design+Code instructor.")
                .lineLimit(10)
            Spacer()
            }
